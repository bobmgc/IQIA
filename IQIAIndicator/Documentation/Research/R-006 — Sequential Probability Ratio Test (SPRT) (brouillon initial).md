R-006 — Sequential Probability Ratio Test (SPRT) (brouillon initial)

> ⚠️ Brouillon initial, conservé pour l'historique. La référence scientifique officielle est
> « R-006 — Sequential Probability Ratio Test (SPRT).md ».
